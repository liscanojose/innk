...
ActiveRecord::Schema.define(version: 20171211211220) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "serie_ids"
    t.integer  "movie_ids"
    t.integer  "movie_ids2", default: [],              array: true
  end

  add_index "users", ["movie_id"], name: "index_users_on_movie_id", using: :btree
  add_index "users", ["serie_id"], name: "index_users_on_serie_id", using: :btree
  add_index "users", ["serie_ids"], name: "index_users_on_serie_ids", using: :btree
